...
class peerProcess {
    ...
    static peerProcess ReadCommongConfig(int peerId) {
        ...
        return new peerProcess(peerId, numberOfPreferredNeighbors, unchokingInterval, optimisticUnchokingInterval, fileName, fileSize, pieceSize);
    }
    ...
    public static void main(String[] args) {
        ...
        After handshaking, peer A sends a ‘bitfield’ message to let peer B know which file pieces
        it has. Peer B will also send its ‘bitfield’ message to peer A, unless it has no pieces.
        If peer A receives a ‘bitfield message from peer B and it finds out that peer B has pieces
        that it doesn doesn’t have, peer A sends ‘interestedinterested’ message to peer B. Otherwise,
        it sends ‘not interested interested’ message.
        */
